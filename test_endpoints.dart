...
import 'lib/core/logger/app_logger.dart';

/// Script para ejecutar pruebas de endpoints y análisis de rendimiento
Future<void> main() async {
  ...
  try {
    ...
    // Guardar resultados de endpoints
    final endpointJson = {
      'timestamp': DateTime.now().toIso8601String(),
      'results': endpointResults,
    };
    // Se guarda en logs también
